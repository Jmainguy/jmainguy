...
| [**soh.re**](https://jmainguy.com/projects/soh-re/) | An interactive Linux terminal in the browser, backed by isolated Kubernetes workloads and a custom routing stack. [Open a terminal](https://soh.re/) · [Isolation proxy](https://github.com/Jmainguy/isolation-proxy) |
